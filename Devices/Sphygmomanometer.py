...
class Sphygmomanometer:
    ...
    def publish_measurements(self, msg):
        ...
        msg_form = {
                    "bn":f"{self.msg_broker}:{self.msg_broker_port}/{self.clientID}/{self.topic_cat}/{self.topic_measurement}",
                    "bt":timestamp,
                    "e": msg
                    }
        
        self.paho_mqtt.publish(f"{self.clientID}/{self.topic_cat}/{self.topic_measurement}", json.dumps(msg_form), 2)
    ...
    def get_measurements(self):
        ...
        measurement = [
                        {"n":"systolic", "u":"mmHg", "v":ss},
                        {"n":"diastolic", "u":"mmHg", "v":ds}
                      ]       
...
if __name__ == "__main__":
    ...
    sphy_dev = Sphygmomanometer(clientID="P300",
                 topic_cat="pressure",
                 topic_measurement="measurements",
                 systolic_threshold=90,
                 diastolic_threshold=60,
